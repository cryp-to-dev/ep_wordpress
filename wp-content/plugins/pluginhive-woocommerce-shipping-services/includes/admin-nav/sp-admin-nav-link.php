...
if (!class_exists('SP_Admin_Nav_Link')) {
    class SP_Admin_Nav_Link
    {
        public function __construct()
        {
            ...
            if (!class_exists("SP_Common_Functions")) {
                require_once '../../sp-common-functions.php';
            }
        }
        ...
        protected function get_asp_token($plugin_settings)
        {
            ...
            $response_body = SP_Common_Functions::make_post_request(SP_WC_ADMIN_TOKEN_URL, $requestBody, $headers);
