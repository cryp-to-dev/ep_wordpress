...
<div class="rh-container"> 
    <div class="rh-content-wrap clearfix">
        ...
        <div class="main-side page woocommerce clearfix full_width">
            ...
            <div class="pb30 <?php echo esc_attr($infinitescrollwrap);?>" data-filterargs='<?php echo ''.$jsonargs.'';?>' data-template="woogridpartajax" id="<?php echo esc_attr($containerid);?>" data-innerargs='<?php echo ''.$json_innerargs.'';?>'>
                    <div class="masonry_grid_fullwidth col_wrap_three products">                
